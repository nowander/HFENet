...
# from rgbt.SF.mix_backbone import MixNetRV
from backbone.mix_backbone import MixNetRV
...
class SFNet(nn.Module):
    def __init__(self):
        ...
        self.rgb_encode = MixNetRV(pretrained=True)
        self.dep_encode = MixNetRV(pretrained=True)
        ...
        self.merge4 = merger_AM(256,1,1)  # merge2()
        self.merge5 = merger_AM(512,1,0)  # merge2()
        self.merge6 = merger_AM(512,0,1)

        self.S5 = merge_corr(512,2,1)
        self.S4 = merge_corr(512,1,1)
        self.S3 = merge_corr(256, 2,1)
        self.S2 = merge_corr(256, 0,0)
        ...
        self.last_conv3 = nn.Sequential(nn.Conv2d(256, 1, kernel_size=1, padding=0))#, nn.BatchNorm2d(1))
    ...
    def forward(self, left, depth):
        ...
        # print('A1',A1.shape)#([4, 64, 224, 224])
        # print('A2', A2.shape)#([4, 64, 112, 112])
        # print('A3', A3.shape)#([4, 128, 56, 56])
        # print('A4', A4.shape)#([4, 256, 28, 28])
        # print('A5', A5.shape)#([4, 512, 14, 14])
        # print('A6', A6.shape)#([4, 512, 7, 7])
        ...
        out33 = out3 + self.conv512_128(self.up8(out))
        ...
        #([4, 64, 224, 224])   ([4, 128, 112, 112]) ([4, 256, 56, 56])
