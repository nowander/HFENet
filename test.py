...
# model.load_state_dict(torch.load('/media/sunfan/date/weight4/VGG16_RES34_LIFM_4/RES34_1_best_mae_test.pth'))
model.load_state_dict(torch.load('/media/sunfan/date/weight4/VGG16_RES34_4_BCE_HIFM/RES34_1_best_mae_test.pth'))
...
# test_datasets = ['COME-E','COME-H','DES','SIP','LFSD','NLPR','SSD','DUT']

for dataset in test_datasets:

    mae_sum  = 0
    save_path = '/media/sunfan/date/salient_Map4/VGG16_RES34_4_BCE_HIFM/' + dataset + '/'
