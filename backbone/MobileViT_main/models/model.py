...
from backbone.MobileViT_main.models.module import InvertedResidual, MobileVitBlock
...
if __name__ == "__main__":
    ...
    cfg_s = model_cfg["s"]
    model_s = MobileViT(224, cfg_s["features"], cfg_s["d"], cfg_s["layers"], cfg_s["expansion_ratio"])

    print(model_s)
    net = model_s
    out1,out2,out3,out4,out5 = net(img)
